...
insertH2BST = (double) (endTime-startTime)/100;
cout << "execution time for hash 2, BST insert, LF=0 : " << insertH2BST << endl;
iFile.close();
iFile.open(argv[1]);  //open 1
...
//
endTime = clock();                                          //end time====================
searchH2BST = (double) (endTime-startTime)/100;
cout << "execution time for hash 2, BST search, LF=0 : " << searchH2BST << endl;
iFile.close();
iFile.open(argv[1]);  //open 1
...
//
endTime = clock();                                          //end time====================
deleteH2BST = (double) (endTime-startTime)/100;
cout << "execution time for hash 2, BST delete, LF=0 : " << deleteH2BST << endl;
iFile.close();
iFile.open(argv[1]);  //open 1
  ...
  endTime = clock();                                          //end time====================
  insertH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST insert, LF=0.1 : " << insertH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST search, LF=0.1 : " << searchH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST delete, LF=0.1 : " << deleteH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST insert, LF=0.2 : " << insertH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST search, LF=0.2 : " << searchH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST delete, LF=0.2 : " << deleteH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST insert, LF=0.5 : " << insertH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST search, LF=0.5 : " << searchH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST delete, LF=0.5 : " << deleteH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST insert, LF=0.7 : " << insertH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST search, LF=0.7 : " << searchH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST delete, LF=0.7 : " << deleteH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST insert, LF=0.9 : " << insertH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST search, LF=0.9 : " << searchH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST delete, LF=0.9 : " << deleteH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST insert, LF=1 : " << insertH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST search, LF=1 : " << searchH2BST << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2BST = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, BST delete, LF=1 : " << deleteH2BST << endl;
  iFile.close();
  cout << endl;
