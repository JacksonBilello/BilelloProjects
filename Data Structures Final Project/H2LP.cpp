...
insertH2LP = (double) (endTime-startTime)/100;
cout << "execution time for hash 2, linear probing insert, LF=0 : " << insertH2LP << endl;
iFile.close();
iFile.open(argv[1]);  //open 1
...
//
endTime = clock();                                          //end time====================
searchH2LP = (double) (endTime-startTime)/100;
cout << "execution time for hash 2, linear probing search, LF=0 : " << searchH2LP << endl;
iFile.close();
iFile.open(argv[1]);  //open 1
...
//
endTime = clock();                                          //end time====================
deleteH2LP = (double) (endTime-startTime)/100;
cout << "execution time for hash 2, linear probing delete, LF=0 : " << deleteH2LP << endl;
iFile.close();
iFile.open(argv[1]);  //open 1
  ...
  endTime = clock();                                          //end time====================
  insertH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing insert, LF=0.1 : " << insertH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing search, LF=0.1 : " << searchH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing delete, LF=0.1 : " << deleteH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing insert, LF=0.2 : " << insertH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing search, LF=0.2 : " << searchH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing delete, LF=0.2 : " << deleteH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing insert, LF=0.5 : " << insertH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing search, LF=0.5 : " << searchH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing delete, LF=0.5 : " << deleteH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing insert, LF=0.7 : " << insertH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing search, LF=0.7 : " << searchH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing delete, LF=0.7 : " << deleteH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing insert, LF=0.9 : " << insertH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing search, LF=0.9 : " << searchH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing delete, LF=0.9 : " << deleteH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  insertH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing insert, LF=1 : " << insertH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  searchH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing search, LF=1 : " << searchH2LP << endl;
  iFile.close();
  iFile.open(argv[1]);
  ...
  endTime = clock();                                          //end time====================
  deleteH2LP = (double) (endTime-startTime)/100;
  cout << "execution time for hash 2, linear probing delete, LF=1 : " << deleteH2LP << endl;
  iFile.close();
  cout << endl;
